...
export const SEASON_STEPS: SeasonStep[] = [
  {
    ...
    tip: ["Watching is always free. You only pay to enter.", "观看始终免费，只有参赛需要付费。"],
  },
  {
    icon: "🪺",
    title: ["Pick a nest", "选择巢穴"],
    body: [
      "The colony has three nests. Each one is linked to a stock ticker. Everything you do during the season counts for the nest you joined.",
      "群落有三个巢穴，每个巢穴对应一只股票代码。赛季期间你的所有操作都计入你加入的巢穴。",
    ],
  ...
  },
  {
    ...
    body: [
      "Feed, water and calm your rats, and watch the colony alerts. Healthy families that grow score more. Trades change the weather for everyone: buys bring food and warmth, sells bring stress.",
      "喂食、饮水、安抚你的大鼠，并留意群落警报。健康且不断壮大的家族得分更高。交易会改变所有人的环境：买入带来食物和温暖，卖出带来压力。",
    ],
  },
  {
    icon: "📈",
