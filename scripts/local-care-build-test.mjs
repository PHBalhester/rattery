...
for(const file of files){
 ...
 for(const marker of ['Local payment lab','/api/care?op=','rattery-local-payment:'])assert(!content.includes(marker),'Local-only payment UI leaked into production bundle: '+file);
}
