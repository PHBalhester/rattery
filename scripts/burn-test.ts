...
function fixture(){return {chain:'0x1237',head:'0xe',tx:structuredClone(tx),receipt:structuredClone(receipt),block:{hash:blockHash,number:'0xa',timestamp:'0x6e'}};}
