...
const marketAddress='0x7dbf38976f6d3b9c529e7d9484a71898b409ee6a',birthBlock=54672454;
const selected=Number(process.env.RATTERY_CAPTURE_BLOCK??'54672454');
...
const transport=readOnlyRPC('https://rpc.mainnet.chain.robinhood.com/rpc');let requests=0;
const rpc=async(method:string,args:unknown[])=>{if(++requests>80)throw Error('Live RPC budget exceeded');return transport(method,args);};
try{
