import {courtyardAreas} from '../src/sim/courtyard';
...
console.log('PASS: indexed navigation matches independent area scan at 15000 random points and every waypoint');
