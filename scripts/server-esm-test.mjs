...
for(const [file,name] of [['worker-runtime','startWorkerRuntime'],['market-collector','MarketCollector'],['historical-prices','HistoricalPrices'],['market-io','readOnlyRPC'],['trade-ledger','TradeLedger'],['auth','StagingAuth'],['persistence','Persistence'],['http','stagingServer'],['simulation-worker','startSimulationWorker']]){
